...
console.log("\n=== Spread Operator ===");
console.log("Asli   :", buah); // tidak berubah console.log('Salinan:', salinanBuah);
...
// 2. Deklarasi array tim
const timA = ["Budi", "Siti", "Ahmad"];
const timB = ["Rina", "Doni"];

// 3. Menggabungkan array dengan spread + tambah anggota baru
...
// 6. Membuat pengaturan user dengan spread
